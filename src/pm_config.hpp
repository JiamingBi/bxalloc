...
/*
 * This file contains macros and consts for bxalloc, some of which are
 * customizable. However, we highly suggest no modification.
 */

/* prefixing indicator */
// persistent data in bxalloc
#define RP_PERSIST
// transient data in bxalloc
#define RP_TRANSIENT
...
const int MAX_SZ = 24*1024;//((1 << 13) + (1 << 11) * 3);
