...
*/
void pmemalloc_activate_helper2(void *abs_ptr);
#define pmemalloc_activate(abs_ptr)		\
	({                       \
    pmemalloc_activate_helper2(abs_ptr); \
  })
...
public:
  allocator(){};
  ~allocator(){};
  virtual void *pmemalloc_init_helper(const char *path, size_t size)=0;
  virtual void *pmemalloc_static_area_helper()=0;
  virtual void *pmemalloc_reserve_helper(size_t size)=0;
  virtual void pmemalloc_free_helper(void *abs_ptr_)=0;
  virtual void pmemalloc_check_helper(const char *path)=0;
  virtual void pmemalloc_activate_helper(void *abs_ptr_)=0;
  virtual void pmemalloc_close_helper()=0;
};

class bx_alloc:public allocator{
public:
  bx_alloc(){};
  ~bx_alloc(){};
  void *pmemalloc_init_helper(const char *path, size_t size);
  void *pmemalloc_static_area_helper();
  void *pmemalloc_reserve_helper(size_t size);
  void pmemalloc_free_helper(void *abs_ptr_);
  void pmemalloc_check_helper(const char *path);
  void pmemalloc_activate_helper(void *abs_ptr_);
  void pmemalloc_close_helper();
};

class makalu_alloc:public allocator{
public:
  makalu_alloc(){};
  ~makalu_alloc(){};
  void *pmemalloc_init_helper(const char *path, size_t size);
...
class nvm_alloc:public allocator{
public:
  nvm_alloc(){};
  ~nvm_alloc(){};
  void *pmemalloc_init_helper(const char *path, size_t size);
...
class pm_alloc:public allocator{
public:
  pm_alloc(){};
  ~pm_alloc(){};
  void *pmemalloc_init_helper(const char *path, size_t size);
...
class pmdk_alloc:public allocator{
public:
  pmdk_alloc(){};
  ~pmdk_alloc(){};
  void *pmemalloc_init_helper(const char *path, size_t size);
